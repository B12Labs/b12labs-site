  ...
  return (
    <div className="w-full px-6 lg:px-8 py-16">
      <div className="max-w-[72ch] mx-auto">
        ...
        <p className="mt-4 text-[17px] text-stone-600 dark:text-stone-400 leading-relaxed">
        ...
        <p className="mt-3 text-[15px] text-stone-600 dark:text-stone-400 leading-relaxed">
          ...
          <a href="https://cintrico.com" className="underline text-[color:var(--brand-solid)]">cintrico.com</a>{" "}
          — same platform, BYOK encryption, SOC 2, centralized spend.{" "}
          <strong>Engram</strong> is the open-source memory layer at{" "}
          <a href="https://github.com/B12Labs/engram" className="underline text-[color:var(--brand-solid)]">
        ...
        <ul className="mt-3 space-y-3 text-[15px] text-stone-600 dark:text-stone-400 leading-relaxed list-disc pl-5">
          ...
          <li>
            ...
            VibeVoice, VoxCPM, Piper, Gemma 4, Qwen 3, MiniCPM all run locally — not just behind an API
            bill.
          </li>
          <li>
